...
public:
  ...
  RC create_index(Trx *trx, const std::vector<const FieldMeta *> &field_metas, const char *index_name) override { return RC::UNIMPLEMENTED; }
  ...
  Index *find_index_by_fields(const std::vector<std::string> &field_names) const override { return nullptr; }
  RC     open() override;
